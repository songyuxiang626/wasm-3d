...
#include "fs_mesh_basic.bin.h"
#include "vs_mesh_basic.bin.h"
...
static const bgfx::EmbeddedShader s_embeddedShaders[] =
{
	...
	BGFX_EMBEDDED_SHADER(vs_mesh_basic),
	BGFX_EMBEDDED_SHADER(fs_mesh_basic),
	...
	: m_fontManager(_fontManager)
{
	...
	m_mesh_program = bgfx::createProgram(
		bgfx::createEmbeddedShader(s_embeddedShaders, type, "vs_mesh_basic"),
		bgfx::createEmbeddedShader(s_embeddedShaders, type, "fs_mesh_basic"),
		true
	);
